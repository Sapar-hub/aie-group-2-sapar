...
| v3 | 500 synth (все) | 10 real | 35 real | исправлено | исправлено | 0.692 | 0.857 |
| v4 (YOLO) | 500 synth (v4) | 10 real | 35 real | исправлено | исправлено | 0.579 | 0.754 |
| v4 (Hybrid) | 500 synth (v4) | 10 real | 35 real | исправлено | исправлено | **0.527** | **0.712** |
| v4 (RCNN) | 500 synth (v4) | 10 real | 35 real | исправлено | исправлено | 0.409 | 0.627 |
...
при `cnn_weight=0.6` (конфиг `hybrid.cnn_weight`). **Не улучшает** YOLO v4 top-1 F1
(F1 = 0.712 vs 0.754, −0.042) — CV-уточнение не добавляет ценности поверх YOLO v4.

Гибрид также **не улучшает** v3 (F1 = 0.857 vs 0.871 у YOLO v3 top-1, −0.014) — модель v3
использует shortcut "белый фон = штамп" для Precision=1.000, но CV-уточнение
...
- `yolo_v3_results.json` — чистый baseline (ориентир, невоспроизводим)
- `hybrid_results.json` — сводное сравнение 6 подходов на v4 (CV, YOLO v3/v4, Hybrid v3/v4, RCNN v4)
- `rcnn_v4_results.json` — RCNN v4 на 35 real (F1=0.627)
