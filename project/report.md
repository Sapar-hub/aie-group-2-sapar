...
|--------|--------|----------|-----------|--------|-----|-----------|
| CV Baseline (без pos map) | v4 | **0.612** | 0.793 | **0.657** | **0.719** | **82.9%** |
| YOLOv8n (top-1) | v4 | 0.502 | 0.833 | 0.571 | 0.678 | 68.6% |
...
3. **Hybrid v4 (F1 = 0.712)** всё ещё ниже чистого CV baseline (+0.034 к YOLO, но −0.007 к CV)
...
6. **CV без обучения** — не требует GPU, данных, и даёт лучший F1 среди воспроизводимых подходов
