...
| 4 | Есть baseline и улучшенная модель, есть **сравнение по метрикам** | ✅ | Все метрики собраны: CV baseline (F1 0.719), YOLO v3 (F1 0.857), YOLO v4 (F1 0.678), Hybrid v4 (F1 0.712). Таблица в `README.md` раздел 5 и `report.md` раздел 5. |
